...
const Footer = () => {
  ...
  return (
    <footer className="bg-[var(--color-primary)] pt-16 pb-8 border-t-[4px] border-[var(--color-secondary)]">
      <div className="main-container">
          ...
          <div className="flex flex-col gap-4">
            ...
            <ul className="flex flex-col gap-3 font-body text-sm md:text-base text-slate-300">
              <li>
                ...
                >
                  <span className="w-1.5 h-1.5 rounded-full bg-slate-600 group-hover:bg-[var(--color-secondary)] transition-colors duration-300"></span>
                  Our Mission & History
                </a>
              </li>
              <li>
          ...
          <div className="flex flex-col gap-4">
            ...
            <address className="not-italic flex flex-col gap-4 font-body text-sm md:text-base text-slate-300">
              <p className="flex items-start gap-3">
                <svg
                  className="w-5 h-5 text-[var(--color-secondary)] mt-0.5 shrink-0"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  strokeWidth={1.5}
              ...
              <p className="flex items-center gap-3">
                ...
                >
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.864-1.051l-3.21-.536a2.25 2.25 0 00-2.516.92l-1.06 1.59a11.92 11.92 0 01-5.739-5.739l1.59-1.06a2.25 2.25 0 00.92-2.516l-.536-3.21a2.25 2.25 0 00-1.051-.864H4.5A2.25 2.25 0 002.25 4.5v2.25z"
                  />
                </svg>
              ...
              <p className="flex items-center gap-3">
                ...
                <span>contact@sewomenofsubstance.org</span>
              </p>
            </address>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="font-body text-xs md:text-sm text-slate-400">
            &copy; {currentYear} South East Women of Substance. All rights
            reserved.
          </p>
